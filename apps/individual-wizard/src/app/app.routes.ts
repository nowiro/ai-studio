...
import { WizardPath } from '@ai-studio/individual-wizard-data';

/**
 * Top-level routes for the individual-wizard demo.
 *
 ...
 * `@ai-studio/individual-wizard-feature`). Components consume the same module's
...
export const APP_ROUTES: Routes = [
  {
    ...
    pathMatch: 'full',
    loadComponent: async () => import('@ai-studio/individual-wizard-feature').then((m) => m.WizardDashboardComponent),
  },
  {
    path: WizardPath.Wizard,
    loadComponent: async () => import('@ai-studio/individual-wizard-feature').then((m) => m.WizardShellComponent),
  },
  {
