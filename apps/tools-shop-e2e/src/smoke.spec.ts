...
/**
 * Tools-shop core smoke: catalogue renders, a product can be added to the cart,
 ...
 */
test.describe('tools-shop — catalogue + cart smoke', () => {
  test('catalogue lists tools, add-to-cart fills the drawer, checkout opens', async ({ page }) => {
    await page.goto('/');
