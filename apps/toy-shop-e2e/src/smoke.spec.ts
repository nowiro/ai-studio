...
/**
 * Toy-shop core smoke: catalogue renders, a product can be added to the cart,
 ...
 */
test.describe('toy-shop — catalogue + cart smoke', () => {
  test('catalogue lists toys, add-to-cart fills the drawer, checkout opens', async ({ page }) => {
    await page.goto('/');
