...
@Component({
  ...
  template: `
    <ais-shop-hero
      [ctaLink]="['/']"
      eyebrow="Profesjonalny sprzęt"
      title="Narzędzia, które po prostu działają"
      subtitle="Elektronarzędzia, narzędzia ręczne i akcesoria — w hurtowych cenach z gwarancją do 5 lat."
      ctaLabel="Zobacz asortyment"
    />
      ...
      <div class="gap-3 flex flex-col">
        ...
        @if (catalogue.filtered().length === 0) {
          <ais-shop-empty-results
            ...
            title="Brak narzędzi"
            subtitle="Żadne narzędzie nie pasuje do aktywnych filtrów. Spróbuj poszerzyć kryteria."
          />
        } @else {
          <div
