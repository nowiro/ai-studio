...
import { WizardFormService, WizardNav } from '@ai-studio/wizard-data';
import type { WizardStepIndex } from '@ai-studio/wizard-data';

type Status = 'done' | 'incomplete' | 'untouched';

interface TileDescriptor {
  readonly step: WizardStepIndex;
  readonly path: string | null; // null for the summary tile (no dedicated sub-form)
